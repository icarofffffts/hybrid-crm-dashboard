      ...
      <div className="relative rounded-3xl overflow-hidden p-10 bg-black/60 border border-white/5 backdrop-blur-2xl shadow-2xl">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/config" className="group flex items-center gap-2 px-6 py-3 rounded-2xl bg-indigo-500 text-white font-semibold hover:bg-indigo-600 transition-all shadow-lg shadow-indigo-500/20 active:scale-95">
            ...
            <Link href="/users" className="group flex items-center gap-2 px-6 py-3 rounded-2xl bg-white/5 border border-white/10 text-white font-semibold hover:bg-white/10 transition-all active:scale-95">
