        ...
        <div className="flex h-screen bg-[#09090b] overflow-hidden">
          ...
          <aside className="w-72 bg-[#121217] border-r border-white/5 flex flex-col relative z-20 shadow-2xl">
            ...
            <nav className="flex-1 px-4 space-y-2">
              ...
              <Link href="/users" className="group flex items-center gap-3 px-4 py-3.5 rounded-xl hover:bg-white/5 transition-all text-sm font-medium text-zinc-400 hover:text-white">
                <span className="p-1.5 rounded-lg bg-white/5 group-hover:bg-violet-500/20 group-hover:text-violet-400 transition-colors">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
                </span>
                Gestão de Usuários
              </Link>
              <Link href="/config" className="group flex items-center gap-3 px-4 py-3.5 rounded-xl hover:bg-white/5 transition-all text-sm font-medium text-zinc-400 hover:text-white">
                <span className="p-1.5 rounded-lg bg-white/5 group-hover:bg-zinc-500/20 group-hover:text-zinc-300 transition-colors">
